...
4. Crea `loan_movements` con `PAYMENT_IN/OUT`
...
4. Llama `LoanRepository.recalculateLoanStatus()` para actualizar estado del préstamo
5. Sincroniza cambios con Firestore
...
2. **Sincronización bidireccional**: Transacciones ↔ Pagos ↔ Préstamos
